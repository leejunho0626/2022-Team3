...
webcam = True
path ='C:/Users/PJS/PycharmProjects/2022-Team3/venv/Lib/1.jpg'
...
while True:
   ...
   if len(conts) !=0:
      ...
      if len(conts) != 0:
         for obj in conts2:
            cv2.polylines(imgContours2,[obj[2]],True,(0.235,0),2)
            nPoints = Utils.reorder(obj[2])
            nW =round((Utils.findDis(nPoints[0][0]//scale,nPoints[1][0]//scale)/10),1)
            nH =round((Utils.findDis(nPoints[0][0]//scale,nPoints[1][0]//scale)/10),1)
   ...
   img = cv2.resize(img,(0,0),None,0.5,0.5)#이미지 크기 조절
